            ...
            <div class="col-md-3 mb-3">
                <div class="card mb-3 h-100">
                    <div class="card-body">
                        ...
                        <hr>
                        <p class="text-muted mb-0"><a href="{{ route('categories.index')}}"><i class="bi bi-bookmarks"></i> {{ trans('main_trans.all_categories') }}</a></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card mb-3 h-100">
                    <div class="card-body">
                        ...
                        <hr>
                        <p class="text-muted mb-0"><a href="{{ route('clients.index') }}"><i class="bi bi-people"></i> {{ trans('main_trans.all_clients') }}</a></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="card mb-3 h-100">
                    <div class="card-body">
                        ...
                        <hr>
                        <p class="text-muted mb-0"><a href="{{ route('products.index') }}"><i class="bi bi-shop"></i> {{ trans('main_trans.all_products') }}</a></p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
              <div class="card mb-3 h-100">
                <div class="card-body">
                    ...
                    <hr>
                    <p class="text-muted mb-0"><a href="{{ route('orders.index') }}"><i class="bi bi-cart"></i> {{ trans('main_trans.all_orders') }}</a></p>
                </div>
            </div>
            </div>
                                        ...
                                        @foreach ($products as $product)
                                            @if ($offresel->product_id == $product->id)
                                                <tr>
                                                    ...
                                                    <td><img src="{{ $product->image_path }}" class="img-fluid" style="width: 70px" alt=""></td>
                                                    <td>{{ $product->name }}</td>
